 ...
 */
public class sevennewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Context context;
        View view =inflater.inflate(R.layout.fragment_sevennews, container, false);

        RecyclerView recyclerView = view.findViewById(R.id.VerticalRecycler3);
